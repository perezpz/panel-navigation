...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const handleScroll = (event: any) => {
      ...
      const isOnTop = document.documentElement.scrollTop === 0;

      setVisible(lastScrollY > scrollY || isOnTop);
      lastScrollY = scrollY;
    };
  ...
  return (
    <>
      ...
      <div className={cls(styles.header, { [styles.hidden]: !visible })}>
        <div className={styles.navbarContainer}>
          <nav className={styles.navbar}>
            <div className={styles.menuLeft}>
              <div className={styles.logo}>
                <img src="/next.svg" alt="svg" />
              </div>
